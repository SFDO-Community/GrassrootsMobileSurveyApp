...
export const CONTACT_ERROR = {
  INVALID_FIELD_WORKER_RECORD: 'CONTACT_ERROR_INVALID_FIELD_WORKER_RECORD',
  UNEXPECTED: 'CONTACT_ERROR_UNEXPECTED',
  JUNCTION_QUERY: 'CONTACT_ERROR_JUNCTION_QUERY',
  JUNCTION_UNEXPECTED: 'CONTACT_ERROR_JUNCTION_UNEXPECTED',
};

export const METADATA_ERROR = {
  INVALID_PACKAGE_VERSION: 'METADATA_ERROR_INVALID_PACKAGE_VERSION',
  NO_EDITABLE_FIELDS: 'METADATA_ERROR_NO_EDITABLE_FIELDS',
  INVALID_RECORD_TYPE: 'METADATA_ERROR_INVALID_RECORD_TYPE',
  UNEXPECTED: 'METADATA_ERROR_UNEXPECTED',
};

export const SYNC_ERROR = {
  API: 'SURVEY_SYNC_ERROR_API',
  UNEXPECTED: 'SURVEY_SYNC_ERROR_UNEXPECTED',
};
